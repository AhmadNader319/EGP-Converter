...
load_dotenv(dotenv_path=os.path.expanduser('/Users/ahmednader/Desktop/Code Repository/EGP-Converter/.env'))
...
CORS_ORIGINS = [origin.strip() for origin in raw.split(",")]
